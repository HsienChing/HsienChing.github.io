...
NOTE: 如果樹莓派的 Linux OS 系統已經經過 raspi-config 的空間擴展，將使用空間擴展到整片 micro SD 卡，請看此Po文 ([縮小樹莓派作業系統使用的硬碟空間，並製作容量較小的img檔]({{ site.baseurl }}{% link _posts/2025-03-20-Modify-img-size-of-linux-OS-Part-1.md %}))。如果樹莓派的 Linux OS 系統沒有經過空間擴展，只是想單純將小容量的作業系統製作 img 檔，請看本Po文。
