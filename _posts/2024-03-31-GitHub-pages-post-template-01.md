...
This can be done by appending the language to the starting backticks (\`\`\`).
...
### 5.1.2 Use `![Alt name](<URL> "Title")`

Use `![Alt name](<URL> "Title")`
...
This format `*-_` cannot built the separation line.
